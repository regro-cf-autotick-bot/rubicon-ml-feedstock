...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/rubicon-ml-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/rubicon-ml-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install rubicon-ml
```
...
It is possible to list all of the versions of `rubicon-ml` available on your platform:
...
```
pixi search rubicon-ml --channel conda-forge
```
